...
(function () {
  ...
  function BootSequence({
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "b-title"
    }, "Starting ", /*#__PURE__*/React.createElement("b", null, "DhanushOS")), /*#__PURE__*/React.createElement("div", {
      className: "b-sub"
    }, "aero edition \xB7 data platform"), done && /*#__PURE__*/React.createElement("div", {
      className: "b-hint"
    }, "\u25B8 click to continue"));
  }
  ...
  function StartMenu({
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "r"
    }, D.profile.role))), /*#__PURE__*/React.createElement("div", {
      className: "sm-cols"
    }, /*#__PURE__*/React.createElement("div", {
      className: "sm-left"
      ...
      }, /*#__PURE__*/React.createElement(G, null), a.title.replace(".app", ""));
    })), /*#__PURE__*/React.createElement("div", {
      className: "sm-right"
    }, places.map(p => {
      const G = I[p.icon];
      ...
      }, /*#__PURE__*/React.createElement(G, null), p.label);
    }), /*#__PURE__*/React.createElement("div", {
      className: "sm-item",
      onClick: () => {
      ...
      onKeyDown: e => {
        if (e.key === "Enter") {
          ...
          const hit = apps.find(a => a.title.toLowerCase().includes(q));
          if (hit) {
            onOpen(hit.id);
            onClose();
          }
  ...
  function Taskbar({
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      return /*#__PURE__*/React.createElement("button", {
        ...
        onClick: () => onOpen(w.id),
        title: w.title
      }, /*#__PURE__*/React.createElement(G, null), /*#__PURE__*/React.createElement("span", {
        className: "tlabel"
      }, w.title.replace(".app", "")));
    }), /*#__PURE__*/React.createElement("div", {
      className: "tray"
